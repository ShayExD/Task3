...
const Register = () => {
    ...
    const handleSubmit = (e) => {
      ...
      if (
        formData.email !== '' && !/^[^\s@]+@[^\s@]+\.(com)$/.test(formData.email) ||
    ...
    return (
      <Container component="main" maxWidth="xs" style={{ backgroundColor: '#f0f0f0' }}>
        <div>
          ...
          <form onSubmit={handleSubmit}>
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <TextField
                  ...
                  required
                  error={formData.username !== '' && !/^[a-zA-Z0-9!@#$%^&*()-_+=|<>?{}[\]:";'.,~\\/]{1,60}$/.test(formData.username)}
                  />
                  {formData.username !== '' && !/^[a-zA-Z0-9!@#$%^&*()-_+=|<>?{}[\]:";'.,~\\/]{1,60}$/.test(formData.username) && (
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={handleChange}
                  required
                  error={formData.password !== '' && !/^(?=.*[0-9])(?=.*[!@#$%^&*])(?=.*[A-Z]).{7,12}$/.test(formData.password)}
                  />
                  {formData.password !== '' && !/^(?=.*[0-9])(?=.*[!@#$%^&*])(?=.*[A-Z]).{7,12}$/.test(formData.password) && (
                <FormHelperText error>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={handleChange}
                  required
                  error={formData.familyName !== '' && !/^\p{L}+$/u.test(formData.familyName)}
            ...
            <TextField
              ...
              //error={formData.email !== '' && !/^[a-zA-Z@.]+\.com$/.test(formData.email)}
               error={formData.email !== '' && !/^[^\s@]+@[^\s@]+\.(com)$/.test(formData.email)
              }
            />
          ...
          <Grid item xs={12} sm={6}>
            ...
            <TextField
              ...
              error={formData.street !== '' && !/^[א-ת\s']+$/i.test(formData.street)}
            />
          ...
          <Grid item xs={12} sm={6}>
            ...
            <TextField
              ...
              required
              // Regex validation for Hebrew letters
              error={formData.number !== '' && !/^[0-9]+$/.test(formData.number)}
            />
            {/* Error message for street */}
            {formData.number !== '' && !/^[0-9]+$/.test(formData.number) && (
              <FormHelperText error>
